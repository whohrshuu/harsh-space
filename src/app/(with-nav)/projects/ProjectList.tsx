            ...
            {allTags.length > 0 && (
                <div className=" flex flex-wrap gap-2">
                    <button
                        ...
                        className={`px-3 py-1 rounded-full text-sm transition-colors border ${selectedTag === null
                    ...
                    {allTags.map((tag) => (
                        <button
                            ...
                            className={`px-3 py-1 rounded-full text-sm transition-colors border ${selectedTag === tag
                                ? "bg-foreground text-background border-foreground"
                                : "bg-transparent text-muted border-transparent hover:bg-black/5"
                                }`}
                        >
